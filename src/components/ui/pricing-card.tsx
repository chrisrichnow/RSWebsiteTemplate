...
function PricingCard() {
  ...
  return (
    <LayoutGroup>
      <div className="w-full max-w-[450px] flex flex-col gap-6 p-5 px-4 sm:p-6 rounded-2xl border border-border bg-background shadow-sm transition-colors duration-300">
        ...
        <button className="w-full rounded-xl bg-primary text-primary-foreground py-3 font-semibold text-sm hover:bg-primary/90 transition-colors">
